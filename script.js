...
document.addEventListener('DOMContentLoaded', function() {
    ...
    segundaImagen.src = "img/audio2.png";
    ...
    if (imagenMusica) {
        imagenMusica.addEventListener('click', function() {
            // Cambiar la imagen
            if (isFirstImage) {
                imagenMusica.src = "img/audio2.png";
                audioPlayer.play();
            } else {
                imagenMusica.src = "img/audio1.png";
                audioPlayer.pause();
...
function actualizarContadorElegante() {
    const fechaEvento = new Date('December 21, 2025 00:00:00').getTime();
